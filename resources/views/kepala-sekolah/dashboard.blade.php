...
@section('content')
    ...
    <div class="p-6">
        ...
        {{-- Judul --}}
        <div class="mb-8">
            <h2 class="text-3xl font-bold text-gray-800">Dashboard Kepala Sekolah SIPESAR</h2>
            <p class="text-gray-600">Pantau proses penerimaan peserta didik baru SD Negeri Larangan</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-teal-100">
            ...
            <div class="p-6 border-b flex flex-col sm:flex-row sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-600">Pantau data pendaftar SPSB</p>
                </div>
                        ...
                        @forelse ($recentRegistrations as $reg)
                            ...
                            <tr class="table-row" data-status="{{ strtolower($status) }}"
                                ...
                                <td class="px-6 py-4 text-sm font-medium">
                                    {{-- Kepala sekolah tidak memiliki aksi verifikasi atau detail admin --}}
            ...
            <div class="px-6 py-4 border-t flex justify-between items-center">
                ...
                {{-- Kepala sekolah tidak memiliki link ke halaman data admin --}}
                <a href="{{ route('kepala-sekolah.calon-siswa') }}" class="text-sm text-teal-600 hover:text-teal-700">Lihat Semua Data
                    →</a>
            </div>
